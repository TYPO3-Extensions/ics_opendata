...
if (t3lib_extMgm::isLoaded('ics_tcafe_admin')) {
	...
	$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['ics_tcafe_admin']['get_TCAFE_Admin_actions_data'][] = 'EXT:ics_od_datastore/hook/class.tx_icsoddatastore_TCAFEAdmin.php:tx_icsoddatastore_TCAFEAdmin';
}
//--- API commands ---
