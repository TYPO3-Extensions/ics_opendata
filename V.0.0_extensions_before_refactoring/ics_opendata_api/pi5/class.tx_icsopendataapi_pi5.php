 ...
 */
class tx_icsopendataapi_pi5 extends tx_icsopendataapi_common {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ics_opendata_api/pi5/class.tx_icsopendataapi_pi5.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ics_opendata_api/pi5/class.tx_icsopendataapi_pi5.php']);
}
