...
class tx_icsopendatastore_recordList extends recordList {
	...
	function getTable($table,$id,$rowlist)	{
		...
		$addWhere = ' AND ' . $table . '.uid IN (SELECT uid_local FROM tx_icsopendatastore_files_filegroup_mm WHERE uid_foreign = ' . $GLOBALS['SOBE']->id . ')';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ics_opendata_store/lib/class.tx_icsopendatastore_recordlist.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ics_opendata_store/lib/class.tx_icsopendatastore_recordlist.php']);
}
