...
function typo3db_opendatapkg_connect()
{
	...
	$host = $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['ics_od_categories']['datasourceconnect']['typo3db_opendatapkg']['host'];
	$login = $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['ics_od_categories']['datasourceconnect']['typo3db_opendatapkg']['login'];
	$password = $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['ics_od_categories']['datasourceconnect']['typo3db_opendatapkg']['password'];
	$base = $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['ics_od_categories']['datasourceconnect']['typo3db_opendatapkg']['base'];
