...
*  Copyright notice
*
*  (c) 2010 technique <technique@in-cite.net>
*  All rights reserved
*
...
require_once( t3lib_extMgm::extPath('ics_opendata_api') . 'mod1/class.tx_icsopendataapi_module1_value.php' );
/**
 * Class 'Commands documentation parameter' for the 'ics_opendata_api' extension.
 *
 * @author	technique <technique@in-cite.net>
 * @package	TYPO3
 * @subpackage	tx_icsopendataapi
 */
class tx_icsopendataapi_module1_parameter{
	private $content = '';
