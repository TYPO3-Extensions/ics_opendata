...
require_once(t3lib_extMgm::extPath('ics_opendata_api') . 'api/class.tx_icsopendataapi_factory.php');
require_once(t3lib_extMgm::extPath('ics_opendata_api') . 'api/class.tx_icsopendataapi_logger.php');
 ...
 * @package    TYPO3
 */
class tx_icsopendataapi_service {
	/**
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ics_opendata_api/api/class.tx_icsopendataapi_service.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ics_opendata_api/api/class.tx_icsopendataapi_service.php']);
}
