 ...
 *
 *
 *   52: class tx_icsopendataapi_pi3 extends tx_icsopendataapi_common
...
/**
 * Plugin 'Stat apikr' for the 'ics_opendata_api' extension.
 *
 * @author	Tsi <tsi@in-cite.net>
 * @package	TYPO3
 * @subpackage	tx_icsopendataapi
 */
class tx_icsopendataapi_pi3 extends tx_icsopendataapi_common {
	var $prefixId      = 'tx_icsopendataapi_pi3';		// Same as class name
	var $scriptRelPath = 'pi3/class.tx_icsopendataapi_pi3.php';	// Path to this script relative to the extension dir.
	...
	function getContent($application, $date){
		...
		$markerArray = array(
			'###CAPTION###' => htmlspecialchars($this->pi_getLL('titre')) . ' : ' . $application['application'],
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ics_opendata_api/pi3/class.tx_icsopendataapi_pi3.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ics_opendata_api/pi3/class.tx_icsopendataapi_pi3.php']);
}
