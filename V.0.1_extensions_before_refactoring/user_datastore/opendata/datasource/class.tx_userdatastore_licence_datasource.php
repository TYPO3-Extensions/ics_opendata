...
/**
 * @file class.tx_userdatastore_licence_datasource.php
 *
...
class tx_userdatastore_licence_datasource
{
	// *************************
	// * User inclusions 0
	...
	public function getLicencesAll($params)
	{
		$queryarray = array();
		$queryarray['fields'] = 
			'`tx_icsopendatastore_licences`.`uid` AS `id`, ' . 
			'`tx_icsopendatastore_licences`.`name` AS `name`, ' . 
			'`tx_icsopendatastore_licences`.`link` AS `link`, ' . 
			'`tx_icsopendatastore_licences`.`logo` AS `logo`';
		$queryarray['fromtable'] = 
			'`tx_icsopendatastore_licences`';
		$queryarray['where'] = 
			'1' . t3lib_BEfunc::deleteClause('tx_icsopendatastore_licences') . t3lib_BEfunc::BEenableFields('tx_icsopendatastore_licences');
		$queryarray['groupby'] = 
			'';
		$queryarray['order'] = 
			'';
...
} // End of class tx_userdatastore_licence_datasource
