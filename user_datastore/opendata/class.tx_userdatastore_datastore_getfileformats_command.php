...
/**
 * @file class.tx_userdatastore_datastore_getfileformats_command.php
 *
...
class tx_userdatastore_datastore_getfileformats_command extends tx_icsopendataapi_command
{
	...
	function execute(array $params, XMLWriter $xmlwriter)
	{
		...
		$datasource = t3lib_div::getUserObj($GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['user_datastore']['datasource']['fileformat']);
...
} // End of class tx_userdatastore_datastore_getfileformats_command
