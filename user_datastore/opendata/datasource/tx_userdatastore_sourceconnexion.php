...
/**
 * @file tx_userdatastore_sourceconnexion.php
 *
...
{
	$host = $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['user_datastore']['datasourceconnect']['typo3db_opendatapkg']['host'];
	$login = $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['user_datastore']['datasourceconnect']['typo3db_opendatapkg']['login'];
	$password = $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['user_datastore']['datasourceconnect']['typo3db_opendatapkg']['password'];
	$base = $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['user_datastore']['datasourceconnect']['typo3db_opendatapkg']['base'];
