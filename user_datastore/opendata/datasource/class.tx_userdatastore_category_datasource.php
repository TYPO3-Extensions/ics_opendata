...
/**
 * @file class.tx_userdatastore_category_datasource.php
 *
...
class tx_userdatastore_category_datasource
{
	// *************************
	// * User inclusions 0
	...
	public function getCategorysAll($params)
	{
		$queryarray = array();
		$queryarray['fields'] = 
			'`tx_icsopendatastore_categories`.`uid` AS `id`, ' . 
			'`tx_icsopendatastore_categories`.`name` AS `name`, ' . 
			'`tx_icsopendatastore_categories`.`description` AS `description`, ' . 
			'`tx_icsopendatastore_categories`.`parent` AS `parent`';
		$queryarray['fromtable'] = 
			'`tx_icsopendatastore_categories`';
		$queryarray['where'] = 
			'1' . t3lib_BEfunc::deleteClause('tx_icsopendatastore_categories') . t3lib_BEfunc::BEenableFields('tx_icsopendatastore_categories');
		$queryarray['groupby'] = 
			'';
		$queryarray['order'] = 
			'';
...
} // End of class tx_userdatastore_category_datasource
