...
/**
 * @file class.tx_userdatastore_datastore_searchdatasets_command.php
 *
 * Short description of the class getagencies
 * 
 * @author    In Cité Solution <technique@in-cite.net>
...
class tx_userdatastore_datastore_searchdatasets_command extends tx_icsopendataapi_command
{
	...
	function execute(array $params, XMLWriter $xmlwriter)
	{
		...
		if (!empty($params['agencies']))
		{
			...
			foreach( $agencies as $agency)
			{
				...
				{
					makeError($xmlwriter, tx_userdatastore_datastore_searchdatasets_command::INVALID_AGENCIES_CODE, tx_userdatastore_datastore_searchdatasets_command::INVALID_AGENCIES_TEXT);
					return;
				}
			}
		}
		...
		if (!empty($params['licences']))
		{
			...
			foreach( $licences as $licence)
			{
				...
				{
					makeError($xmlwriter, tx_userdatastore_datastore_searchdatasets_command::INVALID_LICENCES_CODE, tx_userdatastore_datastore_searchdatasets_command::INVALID_LICENCES_TEXT);
					return;
				}
			}
		}
		if (!empty($params['released']))
		{
			...
			{
				makeError($xmlwriter, tx_userdatastore_datastore_searchdatasets_command::INVALID_RELEASED_CODE, tx_userdatastore_datastore_searchdatasets_command::INVALID_RELEASED_TEXT);
				return;
			}
		}
		if (!empty($params['updated']))
		{
			...
			{
				makeError($xmlwriter, tx_userdatastore_datastore_searchdatasets_command::INVALID_UPDATED_CODE, tx_userdatastore_datastore_searchdatasets_command::INVALID_UPDATED_TEXT);
				return;
			}
		}
...
} // End of class tx_userdatastore_datastore_searchdatasets_command
