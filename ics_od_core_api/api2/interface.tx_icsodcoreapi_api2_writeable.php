...
/**
 * Interface of objects which supports to be writen to a Writer.
 * @author		Pierrick Caillon <pierrick@in-cite.net>
 * @package		TYPO3
 * @subpackage	ics_od_core_api
 */
interface tx_icsodcoreapi_api2_Writeable {
	/**
	 * Outputs the current object to the specified Writer.
