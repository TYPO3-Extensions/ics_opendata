...
define('ERROR_COMMAND_RESULT_CODE', 9); /**< Error codes: Something is wrong with the command implementation. */
define('ERROR_COMMAND_RESULT_TEXT', 'The command result could not be interpreted successfully. Please contact the webmaster.'); /**< Error messages: Something is wrong with the command implementation. */
