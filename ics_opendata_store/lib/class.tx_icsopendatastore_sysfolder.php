 ...
 * to be included in ics_opendata_store to make the same sysfolder feature as DAM for the filegroups repository.
 */
/**
...
class tx_icsopendatastore_sysfolder {
	...
	static function getPid() {
		if (!tx_icsopendatastore_sysfolder::$pid)
			tx_icsopendatastore_sysfolder::$pid = tx_icsopendatastore_sysfolder::init();
		return tx_icsopendatastore_sysfolder::$pid;
	}
	...
	static function init()	{
		...
		$aDocFolders = tx_icsopendatastore_sysfolder::getAvailable();
	...
	static function getPidList() {
		return implode(',',array_keys(tx_icsopendatastore_sysfolder::getAvailable()));
	}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ics_opendata_store/lib/class.tx_icsopendatastore_sysfolder.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ics_opendata_store/lib/class.tx_icsopendatastore_sysfolder.php']);
}
