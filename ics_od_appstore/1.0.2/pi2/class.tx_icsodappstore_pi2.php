 ...
 *  120:     function init()
 *  167:     function renderSucces($messages)
 *  198:     function renderFormCreate($errors = array())
 *  249:     function existAppli()
 *  265:     function registration()
 *  277:     function is_uniqueKey()
 *  295:     function renderFormEdit($application, $errors = array())
 *  350:     function renderFieldImage($value, $field, $template)
 *  413:     function renderField_group_parseFiles($fieldname, $fieldconf, &$files, &$errors, &$succes)
 *  476:     function updateDB($update = true, &$errors = array(), $application = null)
 *  606:     function valueToDB($fieldname, $value, &$errors, &$succes)
 *  624:     function getMarkersForm($edit = false)
 *
 * TOTAL FUNCTIONS: 13
