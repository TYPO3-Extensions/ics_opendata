...
$TCA['tx_icsodappstore_month_logs'] = array (
	'ctrl' => array (
		'title'     => 'LLL:EXT:ics_od_appstore/locallang_db.xml:tx_icsodappstore_month_logs',		
		'label'     => 'application',	
		'tstamp'    => 'tstamp',
		'crdate'    => 'crdate',
		'cruser_id' => 'cruser_id',
		...
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_icsodappstore_month_logs.gif',
	),
);
